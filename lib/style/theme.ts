...
export let defaultTheme = {
  ...
  colors: {
    accent: 'hsl(350, 100%, 40%)',
    highlight: 'hsl(40, 90%, 55%)',
    accentA: 'hsla(0, 100%, 50%, var(--text-opacity)',
    success: 'hsl(120, 67%, 45%)',
    error: 'hsl(0, 67%, 45%)',
    bgButton: 'hsl(350, 1%, 0%)',
    bgSelection: 'crimson',
    bgCheckbox: 'hsl(350, 0%, 70%)',
    bgInput: 'hsl(225, 5%, 100%)',
    bgDrawer: 'hsl(225, 5%, 100%)',
    bgItem: 'hsl(225, 5%, 100%)',
    bgItemActive: 'hsl(225, 5%, 90%)',
    bgContent: 'hsl(225, 5%, 95%)',
    bgHeader: 'hsl(350, 25%, 100%)',
    bgFooter: 'hsl(350, 20%, 0%)',
    bgTable: 'hsl(225, 25%, 40%)',
    bgSidebar: 'hsl(225, 30%, 30%)',
    bgSidebarActive: 'hsl(225, 25%, 40%)',
    bgDropdown: 'hsla(225, 5%, 100%, 0)',
    bgDropdownActive: 'hsla(225, 5%, 90%, 0)',
    textButton: 'hsl(225, 5%, 20%)',
    textTitle: 'hsl(225, 5%, 20%)',
    textCheckbox: 'hsl(350, 5%, 20%)',
    textContent: 'hsl(225, 20%, 20%)',
    textItem: 'hsl(225, 20%, 20%)',
    textItemA: 'hsla(225, 20%, 20%, var(--text-opacity))',
    textItemTitle: 'hsl(225, 10%, 50%)',
    textTable: 'hsl(225, 20%, 5%)',
    textTableHeader: 'hsl(225, 10%, 70%)',
    textHeader: 'hsl(225, 20%, 65%)',
    textFooter: 'hsl(350, 10%, 100%)',
    textFooterActive: 'hsl(350, 0%, 30%)',
    textHeaderActive: 'hsl(225, 10%, 50%)',
    textDropdownActive: 'hsl(350, 0%, 40%)',
...
export let darkTheme: Theme = {
  ...
  colors: {
    accent: 'hsl(20, 90%, 55%)',
    highlight: 'hsl(20, 90%, 55%)',
    accentA: 'hsla(20, 90%, 55%, var(--text-opacity))',
    success: 'hsl(120, 97%, 85%)',
    error: 'hsl(0, 97%, 85%)',
    bgButton: 'hsl(20, 90%, 55%)',
    bgSelection: 'hsla(20, 70%, 55%)',
    bgCheckbox: 'hsl(225, 8%, 28%)',
    bgInput: 'hsl(225, 5%, 20%)',
    bgDrawer: 'hsl(225, 8%, 21%)',
    bgItem: 'hsl(225, 8%, 21%)',
    ...
    bgFooter: 'hsl(225, 10%, 10%)',
    bgDropdown: 'hsl(225, 10%, 10%)',
    bgDropdownActive: 'hsl(225, 10%, 15%)',
    textButton: 'hsl(225, 10%, 90%)',
    textTitle: 'hsl(225, 10%, 90%)',
    textCheckbox: 'hsl(225, 5%, 100%)',
    textContent: 'hsl(225, 15%, 60%)',
    textItem: 'hsl(225, 15%, 75%)',
    textItemA: 'hsl(225, 15%, 75%, var(--text-opacity))',
    textItemTitle: 'hsl(225, 10%, 35%)',
    textHeader: 'hsl(225, 11%, 48%)',
    textFooter: 'hsl(225, 11%, 48%)',
    textFooterActive: 'hsl(225, 11%, 48%)',
    ...
    textDropdownActive: 'hsl(350, 0%, 30%)',
  },
};
